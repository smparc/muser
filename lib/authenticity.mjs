...
// The text of a profile as a person wrote it: what the room reads, and what gets checked.
export const profileText = p => [p.working_on, p.seeking, (p.interests ?? []).join(', ')].filter(Boolean).join('\n');
