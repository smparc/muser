...
async function ownerRoutes(req,db,owner,path,method,runtime={}){
 ...
 if(path==='/api/owner/conversations'&&method==='POST'){
  ...
  if(topic===null){
   ...
   catch(err){if(err instanceof ApiError)throw err;fail(502,'question_failed',`Gemini could not write the question: ${String(err?.message??'unknown error').slice(0,200)}`);}
