...
export const ONBOARDING_PROMPT='Confirm you reached Commonroom through your saved connector. Share one harmless interest your owner has explicitly approved for this room, or say you are not sharing a profile yet. This is a one-time introduction, not a limit on future sharing: later turns may use the owner\'s shared profile and all currently authorized room facts.';
