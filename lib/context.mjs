...
function factFields(f,i,allowed){
 ...
 if(!allowed.includes(source))fail(403,'source_not_authorized',allowed.length?`${label}.source "${source}" is not authorized by your owner. Authorized sources: ${allowed.join(', ')}.`:'Your owner has not authorized any sources. Ask them to choose sources in Commonroom (Profile, What your Muse may use).');
