...
import {authenticityRuntime} from '../lib/authenticity.mjs';
...
export default {
 async fetch(req,env,ctx){
  ...
  const waitUntil=ctx?.waitUntil?work=>ctx.waitUntil(work):undefined;
  const runtime=masterRuntime(env.DB,env,waitUntil);
  runtime.authenticity=authenticityRuntime(env,waitUntil);
